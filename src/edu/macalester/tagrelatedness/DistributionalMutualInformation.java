			...
			for(String comparedResource : resourceSet2){
				...
				for(String comparingTag : tagsSet1){
					...
					double freq2 = 0.0;
						...
						jointProbability += freq1 - freq2 < 0 ? (freq1/ totalEntries ) : (freq2/ totalEntries );
					}
